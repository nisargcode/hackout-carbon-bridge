...
const carbonTrader = {
  name: "Carbon Bridge Operations",
  email: "trader@carbonbridge.io",
};
...
export const accounts = [
  {
    id: 1,
    label: "Carbon Bridge Operations",
    email: "trader@carbonbridge.io",
  },
  {
    id: 2,
    label: "Tata Steel Jamshedpur",
    email: "carbon@tatasteel.com",
  },
  {
    id: 3,
    label: "CleanFuel Synthesis Ltd",
    email: "procurement@cleanfuel.in",
  },
  {
    id: 4,
    label: "CryoTrans Logistics",
